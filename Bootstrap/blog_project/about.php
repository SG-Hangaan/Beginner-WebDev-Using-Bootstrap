...
<body style="background: black;">
	...
	<header style="background-image: url('images/header2.png');">
	...
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-2">
				<p class="lead m-col">"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque 
