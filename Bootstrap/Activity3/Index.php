...
<div class="container-fluid"> <!-- Bootstrap Pager and Pagination -->
	<ul class="pager">
...
<div class="container-fluid"> <!-- Bootstrap Tab and Pill in Dynamic  -->
...
<div class="container-fluid"> <!-- Bootstrap Pill -->
...
<div class="container-fluid"> <!-- Bootstrap List Group Accordion -->
	<div class="panel-group" id="myaccordion">
		...
		<div class="panel panel-danger"> <!-- primary -->
			<div class="panel-heading">
			<h4>
		...
		<div class="collapse panel-collapse" id="colap2">
			<div class="panel-body"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYu1H2D55ffPCbyAqLnD1mzEGh_fsHNzR-QbSUuLy0Qq-SOJHhRyuAfWrUgGjQqaK4gFo&usqp=CAU"></div></div>
		</div>
...
<div class="container-fluid"> <!-- Bootstrap List Group Collapse -->
...
<div class="container-fluid"> <!-- Bootstrap List Group -->
...
<div class="container"> <!-- Bootstrap Collapse Panel -->
	<div class="panel panel-success"> <!-- default, primary,sucess  -->
		<div class="panel-heading">
			<h4><a href="#abc" data-toggle="collapse">This is a panel heading</a></h4>
		</div>
		<div id="abc" class="collapse panel-collapse"> <!-- collapse panel-collapse in -->
...
<div class="container"> <!-- Bootstrap Collapse -->
	<button class="btn btn-info" data-target="">Click to Collapse</button>
	...
	<div id="dtx" class="collapse in"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYu1H2D55ffPCbyAqLnD1mzEGh_fsHNzR-QbSUuLy0Qq-SOJHhRyuAfWrUgGjQqaK4gFo&usqp=CAU"></div>
</div>
...
<div class="container"> <!-- Bootstrap Panel -->
	...
	<div class="panel panel-danger">
		...
		<div class="panel-footer"> This is a panel heading </div>
	</div>
