...
<body>
    <h1>Activity 4</h1>
     ...
     <!-- Bootstrap Form Style Validation -->
    <div class="container">
    ...
    <form class="form-inline">
        ...
        <div class="form-group has-feedback has-sucess">
            <label>Name</label>
             ...
             <label for="comment" class="control-label col-md-2">Comment </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="checkbox">
                            <label><input type="checkbox">BOOTSRAP</label>
                        </div>
                        <div class="checkbox">
...
<hr/>
    ...
    <!-- Bootstrap Navbar -->
    <nav class="navbar navbar-inverse">  <!--or navbar-inverse, -fixed-bottom, -fixed-top -->
        <div class="container">
            <div class="navbar-header">
             <a class="navbar-brand" href="#">College</a>
        </div>
        <div>
            <ul class="nav navbar-nav navbar-right"> <!--navbar-left or default -->
                    <li><a href="#">ccs</a></li>
                    <li><a href="#">CET</a></li>
